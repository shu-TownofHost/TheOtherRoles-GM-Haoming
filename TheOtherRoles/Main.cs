...
namespace TheOtherRoles
{
    ...
    public class TheOtherRolesPlugin : BasePlugin
    {
        ...
        public const string VersionString = "2.9.1.0";
        ...
        public static void UpdateRegions() {
            ...
            var CustomRegion = new DnsRegionInfo(Ip.Value, "HaomingVPS", StringNames.NoTranslation, Ip.Value, Port.Value);
        ...
        public override void Load() {
            ...
            Ip = Config.Bind("Custom", "Custom Server IP", "haoming-server.com");
