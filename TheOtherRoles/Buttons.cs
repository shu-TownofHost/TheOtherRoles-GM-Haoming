            ...
            sheriffKillButton = new CustomButton(
                () => {
                    ...
                    if ((Sheriff.currentTarget.Data.IsImpostor && (Sheriff.currentTarget != Mini.mini || Mini.isGrownUp())) || 
                        ...
                        (Sheriff.canKillNeutrals && (Arsonist.arsonist == Sheriff.currentTarget || Jester.jester == Sheriff.currentTarget || MadScientist.madScientist == Sheriff.currentTarget || Vulture.vulture == Sheriff.currentTarget )) ||
